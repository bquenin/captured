...
// This file has been copied from https://github.com/keybase/go-keychain/blob/master/corefoundation.go
...
func MapToCFDictionary(m map[C.CFTypeRef]C.CFTypeRef) (C.CFDictionaryRef, error) {
	...
	cfDict := C.CFDictionaryCreateSafe(C.kCFAllocatorDefault, keysPointer, valuesPointer, C.CFIndex(numValues),
...
func ArrayToCFArray(a []C.CFTypeRef) C.CFArrayRef {
	...
	return C.CFArrayCreateSafe(C.kCFAllocatorDefault, valuesPointer, C.CFIndex(numValues), &C.kCFTypeArrayCallBacks) //nolint
}
